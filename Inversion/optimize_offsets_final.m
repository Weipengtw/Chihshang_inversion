function [X_dat,final_offsets] = optimize_offsets_final(X_dat,X_err,G_projected_dense,L,S,V,X_time_index)
...
% Find which rows of G correspond to which cells of X_dat
X_G_index = create_G_index_proj(X_dat);
