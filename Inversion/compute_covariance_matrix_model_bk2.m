...
% Should be the same everywhere, unless one wants to prevent slip on a
...
switch which_smoothing
    ...
    case 'exponential'
        ...
        %Cm = bsxfun(@times,exp(-d/lambda).*ss,Em.^2);
    otherwise
