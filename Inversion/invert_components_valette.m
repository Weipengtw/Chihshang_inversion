...
flag_L_var=0;V_sign = 1;positivity_flag=0;fixed_rake_flag=0;direction_factor=1;rake=[];lsqlin_options_flag=0;linprog_options_flag=0;
U_var = speye(numel(U));
%pinv_flag=0;norm_flag=0;lap_flag=1;fnnls_flag=1;lsqnonneg_flag=0;
